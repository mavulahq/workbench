...
export function getRuntimeConfig() {
  return {
    ...
    paymentOutboxPublisherEnabled: process.env.FPAY_OUTBOX_PUBLISHER_ENABLED === 'true',
    paymentOutboxPublisherPollMs: Number(process.env.FPAY_OUTBOX_PUBLISHER_POLL_MS || 1000),
    paymentOutboxPublisherBatchSize: Number(process.env.FPAY_OUTBOX_PUBLISHER_BATCH_SIZE || 25),
    paymentOutboxPublisherLeaseMs: Number(process.env.FPAY_OUTBOX_PUBLISHER_LEASE_MS || 30000),
